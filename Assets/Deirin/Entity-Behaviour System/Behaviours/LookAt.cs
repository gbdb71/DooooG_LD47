namespace Deirin.EB {
    ...
    public class LookAt : BaseBehaviour {
        ...
        [Header("Events")]
        [Tooltip("Called when the target enters the view angle.")] public UltEvent OnTargetSeen;
        [Tooltip("Called when the target exits the view angle.")] public UltEvent OnTargetLost;
        #endregion
